...
if regime == "LMNP réel":
    ...
    apport = st.number_input("Apport personnel (€)", value=0)
    frais_dossier = st.number_input("Frais de dossier bancaire (€)", value=0)
    frais_agence = st.number_input("Frais d'agence (€)", value=0)
    montant_travaux = st.number_input("Travaux (€)", value=0)
    frais_garantie = st.number_input("Frais de garantie ou d'hypothèque (€)", value=0)
    frais_tiers = st.number_input("Frais divers à payer (€)", value=0)
    ...
    frais_entretien = st.number_input("Entretien du bien (€)", value=0)
...
# --------------------------------------------------------------------------------
    ...
    assurance_pno = st.number_input("Assurance habitation (€)", value=0)
    assurance_gli = st.number_input("Assurance GLI (€)", value=0)
    ...
    charges_copro = st.number_input("Charges de copropriété (€)", value=0)
    assurance = st.number_input("Assurance habitation (€)", value=0)
    assurance_gli = st.number_input("Assurance GLI (€)", value=0)
    taxe_fonciere = st.number_input("Taxe foncière (€)", value=0)
    frais_entretien = st.number_input("Frais d’entretien (€)", value=0)
